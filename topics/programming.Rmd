...
2. Perform arithemtic, including performing comparisons.

3. Execute stored instructions

A programming language makes these accessible in convenient forms. Loops, which we will meet soon, are combinations of counters (arithmetic) and comparisons to perform repeated execution of blocks of instructions.
