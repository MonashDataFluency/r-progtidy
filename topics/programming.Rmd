...
Use `renv` to manage installed packages per project, and keep track of the exact versions of packages you've used. Also `rig` can be used to manage R versions.
