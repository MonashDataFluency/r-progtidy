...
Finally, `readr` is nudging us to specify the column types. Otherwise it has to guess, and sometimes guesses wrong. Not guessing things is especially important for programming as opposed to interactive use of R. Have a look at `?read_tsv` to learn about using `col_types`.
