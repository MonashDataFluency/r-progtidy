...
<!---->* Write a thesis, book, or journal article (but also consider using LaTeX for these).
...
<!---->BibTeX format is a little quirky. Sometimes you need to surround text in { } to prevent it being converted to lower case.
...
<!---->R Markdown has layers, like an onion. To really understand what is going on and fully control the appearance of the output, you may need to understand these underlying layers.
...
<!---->If your aim is to produce a PDF document such as a thesis or journal article, you may prefer to write LaTeX directly. R can still be used to produce plots!
