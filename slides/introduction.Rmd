...
* **Matrices** hold tabular data all of the same type, usually numeric. Distinct from data frames in R!

* **"S3" objects** are (usually) a list, with a special class attribute. Example: an lm object holding a linear model.

* **"S4" objects** are a more formal approach to object-orientation. Most heavily used by the Bioconductor project. Example: a GRanges object holding genomic ranges.
